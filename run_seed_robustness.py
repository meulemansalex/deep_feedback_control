...
"""
This is a script to run a certain hyperparameter fixed configuration 
for various random seeds, to test random seed robustness.
"""
...
def run():
    ...
    parser.add_argument('--nb_seeds', type=int, default=5,
